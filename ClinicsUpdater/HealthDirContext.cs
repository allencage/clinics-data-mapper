namespace ClinicsUpdater
{
    ...
    public partial class HealthDirContext : DbContext
    {
        public HealthDirContext()
            : base("name=HealthDirContext")
        {
        ...
        public virtual DbSet<StripeEventLogs> StripeEventLogs { get; set; }
        public virtual DbSet<StripeLocalInvoices> StripeLocalInvoices { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Clinics>()
                .HasMany(e => e.StripeLocalInvoices)
                .WithRequired(e => e.Clinics)
                .HasForeignKey(e => e.ClinicId);
            ...
            modelBuilder.Entity<StripeEventLogs>()
                .Property(e => e.Id)
                .IsUnicode(false);

            modelBuilder.Entity<StripeLocalInvoices>()
                .Property(e => e.StripeId)
                .IsUnicode(false);
